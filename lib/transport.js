 ...
 * @protected
 */
var Transport = module.exports = function(agent) {
  this.agent = agent;
};
...
Transport.prototype.httpRequest = function(params, callback, options) {
  ...
  if (this.agent && toString.apply(this.agent) === '[object Function]') {
    httpRequest = this.agent;
  } else if (options && options.jsonp && jsonp.supported) {
